                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 align-self-center">
                        <div class="left-text-content">
                            <div class="section-heading">
                                ...
                                {{-- {{ Request::session()->get('addedReservation')}} --}}
                    ...
                    <div class="col-lg-6">
                        <div class="contact-form">
                            <form id="contact" action="myreservation" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <div class="left-text-content">
                            <div class="section-heading">
                                <h6>Contact Us</h6>
                                <h2><a href="/login" class="btn btn-outline-danger">First you have to login</a> then You Can
                                    Make A Reservation Or Just walkin to our cafe </h2>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="phone">
